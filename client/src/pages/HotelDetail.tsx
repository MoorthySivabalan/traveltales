...
import {
  ArrowLeft, Star, MapPin, Wifi, Car, Coffee,
  Dumbbell, Waves, CheckCircle, Calendar,
  Users, Loader2, Phone, Mail
} from 'lucide-react'
...
const HotelDetail = () => {
  ...
  const handleBook = () => {
    ...
    navigate(`/checkout/hotel/${hotel?._id}?tier=${tier}&checkin=${checkIn}&checkout=${checkOut}&guests=${guests}&nights=${nights}&total=${totalPrice}`)
  }
        ...
        <div className="absolute bottom-0 left-0 right-0 p-6 md:p-10">
          <div className="max-w-7xl mx-auto">
            <div className="flex flex-wrap gap-2 mb-2">
              <span className={`text-xs font-medium px-2.5 py-1 rounded-full capitalize ${typeColors[hotel.type]}`}>
                {hotel.type}
              </span>
            ...
            <h1 className="font-serif text-3xl md:text-5xl text-white mb-2">{hotel.name}</h1>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <div className="bg-white dark:bg-gray-900 rounded-2xl p-6 border border-gray-100 dark:border-gray-800">
              <h2 className="font-serif text-2xl text-navy dark:text-white mb-3">About</h2>
            ...
            {/* Amenities */}
            <div className="bg-white dark:bg-gray-900 rounded-2xl p-6 border border-gray-100 dark:border-gray-800">
              <h2 className="font-serif text-2xl text-navy dark:text-white mb-4">Amenities</h2>
            ...
            {/* Map */}
            <div className="bg-white dark:bg-gray-900 rounded-2xl p-6 border border-gray-100 dark:border-gray-800">
              <h2 className="font-serif text-2xl text-navy dark:text-white mb-4">Location</h2>
              <TripMapView
                places={[{
            ...
            {/* Contact */}
            <div className="bg-white dark:bg-gray-900 rounded-2xl p-6 border border-gray-100 dark:border-gray-800">
              <h2 className="font-serif text-2xl text-navy dark:text-white mb-4">Contact</h2>
          ...
          <div className="space-y-5">
            <div className="sticky top-20 space-y-5">
                ...
                {checkIn && checkOut && nights > 0 && (
                  <div className="space-y-2 mb-4 p-3 bg-gray-50 dark:bg-gray-800 rounded-xl text-sm">
                    <div className="flex justify-between text-gray-500 dark:text-gray-400">
                      <span>₹{hotel.pricePerNight[tier].toLocaleString('en-IN')} × {nights} nights</span>
                      <span>₹{(hotel.pricePerNight[tier] * nights).toLocaleString('en-IN')}</span>
                    </div>
                    <div className="flex justify-between text-gray-500 dark:text-gray-400">
              ...
              <div className="bg-navy dark:bg-gray-900 rounded-2xl p-5 border border-gray-800">
                <h4 className="text-white font-medium text-sm mb-3">Hotel Summary</h4>
                <ul className="space-y-2">
                  {[
                    { label: 'Location', value: `${hotel.city}, ${hotel.state}` },
                    { label: 'Region', value: hotel.region },
                    { label: 'Type', value: hotel.type },
                    { label: 'Rating', value: `${hotel.rating} ⭐ (${hotel.reviews.toLocaleString('en-IN')} reviews)` },
                  ].map(item => (
